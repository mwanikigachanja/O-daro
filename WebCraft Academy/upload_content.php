...
<body>
  ...
  <form action="process_upload_content.php" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
      <label for="content">Select Content File:</label>
      <input type="file" name="content" id="content" class="form-control-file" required>
    </div>

    <button type="submit" name="submit" class="btn btn-primary">Upload Content</button>
  </form>
